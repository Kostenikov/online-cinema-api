...
from security.permissions import require_user, require_admin, require_moderator
...
async def request_password_reset_token(
    ...
    reset_link = f"http://127.0.0.1/api/v1/accounts/reset_password/?token={reset_token.token}"  # Todo change
...
async def reset_password(
    ...
    try:
        ...
        reset_link = "http://127.0.0.1/api/v1/accounts/reset_password/complete/"  # Todo change this
