...
from database import UserGroupEnum, UserGroupModel, get_db_contextmanager, reset_database, UserModel, MovieModel
...
async def movie(db_session):
    movie = MovieModel(
        name="test", year=2015, time=90, imdb=8.0, votes=2, meta_score=8.0,
        gross=5.0, price=228.0, description="dsc", certification_id=1,
    )
